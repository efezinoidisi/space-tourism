...
type CardProps = {
  ...
  currentIndex: number;
  crewLength: number;
  updateIsPaused: (value: boolean) => void;
};
...
export default function Card(props: CardProps) {
  ...
  return (
    <article className="flex flex-col-reverse md:flex-col lg:grid lg:grid-cols-2 gap-10 text-center lg:text-start mt-12 lg:mt-0">
      <div
        className="self-center  lg:col-span-1 flex flex-col-reverse md:flex-col gap-5 animate-fade-in"
      ...
      <div className="border-b flex flex-col justify-center border-[#383B4B] md:border-none">
        <ImageWrapper
          src={image}
          className="w-56 self-center lg:w-[25rem] col-span-2 lg:col-span-1 animate-slide-in"
        />
      </div>
    </article>
  );
