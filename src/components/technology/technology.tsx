...
export default function Technology(props: TechnologyProps) {
  ...
  return (
    <section className="flex flex-col lg:flex-row-reverse gap-10 items-center pt-5 lg:pb-9 lg:gap-20">
      <>
        <ImageWrapper
          className="hidden lg:block lg:w-2/6 animate-slide-in"
          src={images.portrait}
        />
        <ImageWrapper
          className="lg:hidden w-full animate-slide-in"
          src={images.landscape}
        />
      </>
      <div className="flex justify-between flex-col lg:flex-row gap-10 items-center lg:w-4/6 lg:items-start lg:justify-start animate-fade-in">
